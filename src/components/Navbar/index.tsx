...
import avatarImage from "staticImages/friend-req.png";
import profileOneImage from "staticImages/profile-1.png";
import profileImage from "staticImages/profile.png";
                                                ...
                                                {notificationFeed.map((item) => (
                                                    <div className="_notification_box" key={item.id}>
                                                        <div className="_notification_image">
                                                            <img src={item.avatar} alt="Image" className="_notify_img" />
                                                        </div>
                                ...
                                <ul className="_nav_dropdown_list">
                                    ...
                                    <li className="_nav_dropdown_list_item">
                                        <a href="#0" className="_nav_dropdown_link" onClick={handleLogout}>
                                            ...
                                            <button type="button" className="_nav_drop_btn_link" onClick={handleLogout}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none" viewBox="0 0 6 10">
                                                    <path fill="#112032" d="M5 5l.354.354L5.707 5l-.353-.354L5 5zM1.354 9.354l4-4-.708-.708-4 4 .708.708zm4-4.708l-4-4-.708.708 4 4 .708-.708z" opacity=".5" />
                                                </svg>
                                            </button>
